...
public class Operador {
  ...
  public Operador(String nombre, String apellidoP, String apellidoM, String fecha, String direccion, char genero,
      String gradoMaximo, String telefono, String horario, String dias) {
    this.nombre = nombre;
  ...
  public String toString() {
    return this.nombre + "," + this.apellidoP + "," + this.apellidoM + "," + this.fecha + "," + this.direccion + ","
        + this.genero + "," + this.gradoMaximo + "," + this.telefono + "," + this.horario + "," + this.dias;
  }
