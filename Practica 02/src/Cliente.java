...
public class Cliente {
    ...
    public Cliente(String nombre, String apellidos, String curp, String direccion, String fecha_de_nacimiento, int edad, String email, String password, String metodo_de_pago, int puntos_de_promociones){
        this.nombre=nombre;
   ...
   */
    ...
    public String toString(){
        return this.nombre + "," + this.apellidos + "," + this.curp + "," + this.direccion + "," + this.fecha_de_nacimiento + "," + this.edad
        + "," + this.email + "," + this.password + "," + this.metodo_de_pago + "," + this.puntos_de_promociones;
    }
